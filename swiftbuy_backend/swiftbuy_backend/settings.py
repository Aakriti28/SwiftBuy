"""
Django settings for swiftbuy_backend project.
...
SECRET_KEY = 'django-insecure-m3ag1*$nq@n0!kpz5x#&qhu7=6i8*kkun*olob$sx88ottxbx@'
...
WSGI_APPLICATION = 'swiftbuy_backend.wsgi.application'
